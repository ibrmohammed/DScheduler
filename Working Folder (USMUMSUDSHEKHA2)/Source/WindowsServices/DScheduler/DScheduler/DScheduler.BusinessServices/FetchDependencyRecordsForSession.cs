...
{
    public class FetchDependencyRecordsForSession: Job
    {
        int numberOfThreads;
        ...
        /// </summary>
        public FetchDependencyRecordsForSession(IEnumerable<ScheduledSessionDetails> scheduledJobs, int numberOfThreads, string  connectionString)
            : base()
        {
